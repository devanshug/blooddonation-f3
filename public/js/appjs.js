$(document).ready(function() {
	...
	$('#captchaverify').click(function() {
		$('#responsestring').load('verify/captcha_api?password='+$('#captchacode').val()+'&random='+$('#random').val(), function( response, status, xhr ) {
	...
	$('.textcomponent-active').each(function(index, element) {
		var $element = $(element);
